...
- `tribot_description/urdf/tribot.urdf` — contains the URDF file(s) defining the robot's links, joints, sensors, and inertial properties
...
## Key conventions
- The robot is simulated using PyBullet
